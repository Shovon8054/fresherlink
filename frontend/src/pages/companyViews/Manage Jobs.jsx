        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '20px' }}>
          {jobs.map((job) => (
            <div key={job._id} style={{
              ...
              <h3 style={{ marginTop: 0, marginBottom: '10px', fontSize: '1.1rem', color: '#111827' }}>{job.title}</h3>
              ...
              <div style={{ fontSize: '0.9rem', color: '#4b5563', marginBottom: '15px' }}>
                ...
                <p style={{ margin: '4px 0' }}><strong>Posted:</strong> {new Date(job.createdAt).toLocaleDateString()}</p>
              </div>
