    ...
    <div style={{ padding: "20px", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: "20px", borderBottom: "2px solid #ddd" }}>
        ...
        <button
          ...
          style={{
            padding: "10px 20px",
            backgroundColor:
              view === "applications" ? "#007bff" : "transparent",
              ...
              {applications.map((app) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p>
                      <strong>Type:</strong> {app.jobId?.type || "N/A"}
                    </p>
                    <p>
      ...
      {view === "recommended" && (
        <div>
          ...
          <p style={{ color: "#666", marginBottom: "20px" }}>
            Jobs matching your skills. Update your profile with skills to get
            better recommendations!
          </p>
          {recommendedJobs.length === 0 ? (
            <p>
              No recommendations available. Add skills to your profile to get
